...
$casa1=0;
$casa2=0;
echo "<p class='casa'><br><br>".$_SESSION['nome']." está na casa ".$casa1."<br></p>";
echo "<p class='casa'><br>".$jogador." está na casa ".$casa2."<br></p>";
do {
$dado1 =  rand(1,6);
$dado2 =  rand(1,6);
$passo1= $casa1+=$dado1;
$passo2= $casa2+=$dado2;
    ...
    echo "<br>Dado: ".$dado2;
    echo "<p class='cas'><br>".$jogador." foi para a casa ".$passo2."<br></p>";
    
    if(($passo2==2)||($passo2==15)||($passo2==23)||($passo2==28)||($passo2==36)){
        $casa2+=2;
        echo "<b>Avança mais 2 casas</b>";
        echo "<p class='cas'><br>".$jogador." foi para a casa ".$casa2."<br></p>";
    }
