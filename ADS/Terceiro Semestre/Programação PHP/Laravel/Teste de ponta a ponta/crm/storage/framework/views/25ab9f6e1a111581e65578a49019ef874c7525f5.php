...
unset($__errorArgs, $__bag); ?>
      ...
      <div class="row">
        ...
        <a href="<?php echo e(url('cadastroServico')); ?>" class="col-3 btn btn-danger rounded mx-auto d-block" value=""> Agenda Serviço</a>
      </div>
           
           
           
   </form>
</div><?php /**PATH C:\Users\Visitante\Desktop\IFSP\Terceiro Semestre\Programação (Segunda)\Laravel\projeto\crm\resources\views/mdb/forms/venda.blade.php ENDPATH**/ ?>